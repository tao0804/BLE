...
const struct attm_desc proj_template_server_att_db[PROJ_TEMPLATE_IDX_NB] =
{
	...
	[PROJ_TEMPLATE_IDX_TEMP_CHAR]		= { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_TEMP_VAL]		= { TRX_CHAR_TEMP_UUID, PERM(RD, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },

	[PROJ_TEMPLATE_IDX_COUNT_CHAR]		= { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_COUNT_VAL]		= { TRX_CHAR_COUNT_UUID, PERM(RD, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },

	[PROJ_TEMPLATE_IDX_CONST_CHAR]		= { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_CONST_VAL]		= { TRX_CHAR_CONST_UUID, PERM(RD, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },

	[PROJ_TEMPLATE_IDX_HISTORY_CHAR]	= { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_HISTORY_VAL]		= { TRX_CHAR_HISTORY_UUID, PERM(RD, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },

	[PROJ_TEMPLATE_IDX_CONFIG_CHAR]		= { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_CONFIG_VAL]		= { TRX_CHAR_CONFIG_UUID, PERM(RD, ENABLE) | PERM(WRITE_COMMAND, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },

	// [PROJ_TEMPLATE_IDX_VBATT_CHAR]		= { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	// [PROJ_TEMPLATE_IDX_VBATT_VAL]		= { TRX_CHAR_VBATT_UUID, PERM(RD, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },
