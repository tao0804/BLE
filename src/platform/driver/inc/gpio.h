 ...
 * $Revision: 2 $
 * $Date: 16/02/25 17:21 $ 
 * @brief    PN102 series GPIO driver header file
 *
 * @note
...
/** @addtogroup PN102_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*---------------------------------------------------------------------------------------------------------*/
/*  PULLUP Enable/Disable Definitions
*/
/*---------------------------------------------------------------------------------------------------------*/
#define GPIO_PULLUP_DISABLE               0UL              
#define GPIO_PULLUP_ENABLE                1UL               
...
/*@}*/ /* end of group PN102_GPIO_EXPORTED_CONSTANTS */
...
static inline void GPIO_ClearBits(GPIO_T* GPIOx, uint32_t GPIO_Pin) 
{
    GPIOx->DOUT &= ~GPIO_Pin;
}
